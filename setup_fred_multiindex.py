...
def fred_multiindex_df_from_csv(coordinates=None):
    ...
    for file_name in filename_list:
        ...
        if col_name == 'roughness_length':
            if not coordinates:
                ...
                data = data.asfreq('30Min', method='pad')
    ...
    fred_data.to_csv(file_directory + 'fred_data_2015_WF1.csv')
...
if __name__ == '__main__':
    ...
    fred_multiindex_df_from_csv(coordinates=coordinates_wf_1)
