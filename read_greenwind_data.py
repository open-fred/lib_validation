...
#                 (wt_data['Datum(Remote)'] + wt_data['Uhrzeit(Remote)']).apply(
#                     str), format='%d.%m.%Y%H:%M:%S')
#             wt_data.set_index('timeindex', inplace=True)
#             # delete unnecessary columns
#             keep_cols = ['Windgeschwindigkeit', 'Leistung', 'Gondelposition',
#                          'Fehlernummer']
#             wt_data = wt_data[keep_cols]
#             # rename other columns
#             wt_data.columns = [
#                 '{}_{}_wind_speed'.format(windfarm_alias[windfarm], wt_number),
#                 '{}_{}_power_output'.format(windfarm_alias[windfarm],
#                                             wt_number),
#                 '{}_{}_wind_dir'.format(windfarm_alias[windfarm], wt_number),
...
data = windfarm_df[['wf_6_4_power_output', 'wf_6_3_wind_speed']]
